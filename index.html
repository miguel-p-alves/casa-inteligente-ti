  ...
  <body>
    ...
    <main class="dashboard-shell">
              ...
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between gap-3">
                  <div>
                    ...
                    <p class="sensor-meta mb-0">Conforto térmico</p>
                  </div>
                  <span class="sensor-icon"><i class="bi bi-thermometer-half"></i></span>
                </div>
                <div class="sensor-value">21,6 °C</div>
                <div class="d-flex align-items-center justify-content-between gap-2 mt-3">
                  <span class="sensor-meta">Origem: MCU</span>
                  <span class="state-badge state-off">Atualizado</span>
                </div>
              </div>
            </div>
          </article>
          ...
          <article class="col-12 col-sm-6 col-xl-4">
            <div class="card sensor-card h-100">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between gap-3">
                  <div>
                    <h3 class="sensor-title">Humidade</h3>
                    <p class="sensor-meta mb-0">Ambiente interior</p>
                  </div>
                  <span class="sensor-icon"><i class="bi bi-droplet-half"></i></span>
                </div>
          ...
          <article class="col-12 col-sm-6 col-xl-4">
            <div class="card sensor-card h-100">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between gap-3">
                  <div>
                    <h3 class="sensor-title">Luminosidade</h3>
                    <p class="sensor-meta mb-0">Luz ambiente</p>
                  </div>
                  <span class="sensor-icon"><i class="bi bi-brightness-high"></i></span>
                </div>
              ...
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between gap-3">
                  <div>
                    ...
                    <p class="sensor-meta mb-0">Sala principal</p>
                  </div>
                  <span class="sensor-icon"><i class="bi bi-person-walking"></i></span>
                </div>
                <div class="sensor-value">Sem movimento</div>
                <div class="d-flex align-items-center justify-content-between gap-2 mt-3">
                  <span class="sensor-meta">Origem: SBC</span>
                  <span class="state-badge state-off">Inativo</span>
                </div>
              </div>
            </div>
          </article>
      ...
      <section class="dashboard-section" id="atuadores">
        ...
        <div class="row g-3">
          <article class="col-12 col-sm-6 col-xl-4">
            <div class="card actuator-card actuator-active h-100" id="cartaoLuz">
              <div class="card-body d-flex flex-column">
                <div class="d-flex align-items-start justify-content-between gap-3">
                  <div>
                    <h3 class="actuator-title">Luz principal</h3>
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 mt-auto pt-4">
                  <span class="state-badge state-on" id="estadoLuz">Ligado</span>
                  <button class="btn btn-outline-secondary control-button" type="button" id="botaoLuz" onclick="alternarAtuador('cartaoLuz', 'estadoLuz', 'botaoLuz', 'Ligado', 'Desligado', 'Desligar', 'Ligar')">
                    Desligar
                  </button>
                </div>
              </div>
          ...
          <article class="col-12 col-sm-6 col-xl-4">
            <div class="card actuator-card h-100" id="cartaoAlarme">
              <div class="card-body d-flex flex-column">
                <div class="d-flex align-items-start justify-content-between gap-3">
                  <div>
                    <h3 class="actuator-title">Alarme</h3>
                    <p class="sensor-meta mb-0">Controlo local</p>
                  </div>
                  <span class="actuator-icon"><i class="bi bi-shield-lock"></i></span>
                </div>
                <div class="d-flex align-items-center justify-content-between gap-2 mt-auto pt-4">
                  <span class="state-badge state-off" id="estadoAlarme">Inativo</span>
                  <button class="btn btn-primary control-button" type="button" id="botaoAlarme" onclick="alternarAtuador('cartaoAlarme', 'estadoAlarme', 'botaoAlarme', 'Ativo', 'Inativo', 'Desativar', 'Ativar')">
                    Ativar
                  </button>
                </div>
              </div>
          ...
          <article class="col-12 col-sm-6 col-xl-4">
            <div class="card actuator-card h-100" id="cartaoVentoinha">
              <div class="card-body d-flex flex-column">
                <div class="d-flex align-items-start justify-content-between gap-3">
                  <div>
                    <h3 class="actuator-title">Ventoinha</h3>
                    <p class="sensor-meta mb-0">Controlo local</p>
                  </div>
                  <span class="actuator-icon"><i class="bi bi-fan"></i></span>
                </div>
                <div class="d-flex align-items-center justify-content-between gap-2 mt-auto pt-4">
                  <span class="state-badge state-off" id="estadoVentoinha">Desligado</span>
                  <button class="btn btn-primary control-button" type="button" id="botaoVentoinha" onclick="alternarAtuador('cartaoVentoinha', 'estadoVentoinha', 'botaoVentoinha', 'Ligado', 'Desligado', 'Desligar', 'Ligar')">
                    Ligar
                  </button>
                </div>
              </div>
          ...
          <article class="col-12 col-sm-6 col-xl-4">
            <div class="card actuator-card h-100" id="cartaoGaragem">
              <div class="card-body d-flex flex-column">
                <div class="d-flex align-items-start justify-content-between gap-3">
                  <div>
                    <h3 class="actuator-title">Porta/Garagem</h3>
                    <p class="sensor-meta mb-0">Controlo local</p>
                  </div>
                  <span class="actuator-icon"><i class="bi bi-door-open"></i></span>
                </div>
                <div class="d-flex align-items-center justify-content-between gap-2 mt-auto pt-4">
                  <span class="state-badge state-off" id="estadoGaragem">Fechado</span>
                  <button class="btn btn-primary control-button" type="button" id="botaoGaragem" onclick="alternarAtuador('cartaoGaragem', 'estadoGaragem', 'botaoGaragem', 'Aberto', 'Fechado', 'Fechar', 'Abrir')">
                    Abrir
                  </button>
                </div>
              </div>
